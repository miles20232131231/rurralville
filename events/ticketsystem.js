...
module.exports = {
    ...
    async execute(interaction) {
        const logChannelId = '1284908444800782357'; // Log channel ID
        const logChannel = interaction.guild?.channels.cache.get(logChannelId);
        const ticketCategoryId = '1284908401544921214'; // Tickets category ID
            ...
            if (interaction.isStringSelectMenu()) {
                ...
                if (interaction.customId === 'ticket_select') {
                    ...
                    const embed = new EmbedBuilder()
                        ...
                        .setThumbnail("https://cdn.discordapp.com/icons/1249174255342714952/034a31c84f87ed83e15da923d2a52f18.png?size=4096")
                        .setColor('#f3ca9a');
